...
import { uploadFileAndReturnUrl } from "../../../../../../api-service/storage-service";
import { createEvent, updateEvent } from "../../../../../../api-service/event-service";
...
export interface EventFormStepProps {
  ...
  setCurrentStep: any;
  currentStep: any;
  selectededMediaFile?: any;
  setSelectedMediaFile?: any;
  loading?: boolean;
  onFinish?: any;
}
function EventForm({
  ...
  const [selectededMediaFile, setSelectedMediaFile] = useState([]);
  ...
  const onFinish = async () => {
    try {
      ...
      const [...urls] = await Promise.all(
        selectededMediaFile.map(async (file: any) => {

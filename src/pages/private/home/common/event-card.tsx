...
function EventCard({ event }: { event: EventType }) {
  ...
  return (
    <div className="grid lg:grid-cols-3 grid-cols-1 border border-solid border-gray-500 items-center gap-5">
      <div className="col-span-1">
        ...
        />
          ...
          <div className="col-span-2 flex flex-col gap-5 p-3">
              <h1 className="text-primary font-bold">{event.name}</h1>
              ...
              <div className="flex justify-between items-center">
                  ...
                  <Button type="primary" onClick={()=>navigate(`/event/${event._id}`)}>View Details</Button>
              </div>
          </div>
    </div>
  );
